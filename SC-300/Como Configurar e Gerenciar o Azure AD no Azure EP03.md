...
- ## Domínio Personalizado
	- O que é um domínio no Azure AD?
		...
		- **Domínio Personalizado**: Quando você cria um diretório  no Azure AD, ele vem com um domínio padrão no formato "<nome_do_diretório>.onmicrosoft.com". No entanto, a maioria das organizações quer usar seus própirosdomínios, com empresa.com.br. O Azure AD permite que você adicione seus próprios domínios personalizados e configure-os para o uso com Azure 