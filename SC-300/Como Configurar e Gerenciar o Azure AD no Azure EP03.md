...
- ## Unidades Administrativas 
	- O que são unidades administrativas?
		...
		- **Requisitos de Licença**
			- **Azure AD Premium P1** em cada administrador da unidade administrativa que recebe funções de diretório no escopo da unidade administrativa. E uma **Azure AD Gratuito** em cada membro da unidade administrativa