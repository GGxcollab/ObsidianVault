...
- ##### É questao de prova saber quais sao as permissões que são necessarias para conectar o Azure AD Connect com o Azure AD e o Azure AD Connect com o on-premisses
- ## Connect to Azure AD
