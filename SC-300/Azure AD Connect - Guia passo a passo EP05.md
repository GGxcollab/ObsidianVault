- ## User sign-in (prova)
	...
	- **Federation with AD FS (Federation Server)** / **Federation with PingFederate**
		...
		- Tem comunicação direta com o Active Directory, onde ter que ter conhecimento do user e pass nessa comunicação, logo deve tambem deixar o FS junto com o AD em um 
		- Como funciona:
