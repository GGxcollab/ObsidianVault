...
- **Propriedade de Segurança Discricionária** (**Discretionary-Security Property**): Esta propriedade utiliza uma matriz de acesso para permitir operações de leitura e escrita. Um exemplo de matriz de acesso é mostrado na tabela abaixo e utilizado em conjunto com as duas primeiras propriedades.
