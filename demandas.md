- O **Plataforma DevSecOps** - minha ultima demanda foi Aplicação do fluxo deploy do arquivo azure-pipeline no repositorio do usuário a partir da escolha do usuário pela plataforma web do DevSecOps
